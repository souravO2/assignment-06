...
const Hero = () => {
  return (
    <main className="flex flex-col items-center justify-between gap-12 p-8 lg:container mx-2 lg:mx-auto lg:flex-row lg:gap-25 lg:py-20 bg-[#222630] rounded-3xl my-8">
