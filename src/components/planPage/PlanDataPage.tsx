  ...
  return (
    <div className="relative my-4 overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/40 backdrop-blur-md shadow-xl transition-all duration-300 hover:border-slate-700/60 flex flex-col md:flex-row md:items-center md:justify-between">
      ...
      <div className="flex items-center gap-2 p-4 pt-0 md:pt-4 md:mx-6 md:p-0 md:flex-col lg:flex-row">
        <Link href={`${data.id}`} className="flex-1 md:flex-none">
          <button className="btn w-full rounded-2xl border border-slate-700/80 bg-slate-800/40 px-4 py-3 text-xs font-semibold text-slate-300 transition-all active:scale-95 hover:border-slate-600 hover:bg-slate-800/80 md:w-auto">
            View Details
          </button>
        </Link>
        ...
        <button
          ...
          className="btn flex flex-1 items-center justify-center gap-2 rounded-2xl bg-[#C2F800] px-5 py-3 text-xs font-bold text-black shadow-lg shadow-[#C2F800]/10 transition-all active:scale-95 hover:bg-[#b2e600] md:flex-none md:w-auto"
        >
          <ImCheckmark className="text-xs" />
